...
<body style="background-color: rgb(50,50,50)">
    ...
    <br>
        ...
        <?php
$consulta = "SELECT * FROM productos WHERE categoria like'relojes%' ORDER BY id ASC";
$pulseras = mysqli_query($conexion,$consulta);
            ...
            ?><div class="grid-container">
                <?php
                    ...
                    <h5 style="color: rgb(198, 168, 125)"><?php echo $fila['nombre'] ?></h5>
                
                <h6 style="color: rgb(198, 168, 125)">Precio: <?php echo '$'.$fila['precio'] ?></h6>
                </div>
