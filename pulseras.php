...
<body style="background-color: rgb(50,50,50)">
    <?php navBar();  ?>
    <br>
    <h2 style="text-align:center;color: rgb(198, 168, 125);font-family:Verdana, sans-serif;">PULSERAS</h2>
    <hr class="solid" style="border-top: 2px solid #bbb;" >
    <br>
        <?php
$consulta = "SELECT * FROM productos WHERE categoria like'pulsera%' ORDER BY id ASC";
